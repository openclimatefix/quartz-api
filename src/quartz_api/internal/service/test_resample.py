...
class TestResampleGeneration(unittest.TestCase):
    def test_resample_generation_1_period(self):
        ...
        self.assertEqual(values[0].Time, pd.Timestamp("2021-01-01T00:00:00Z"))
        self.assertEqual(values[0].PowerKW, 1.5)


    def test_resample_generation_3_periods_with_gaps(self):
        ...
        self.assertEqual(values[0].Time, pd.Timestamp("2021-01-01T00:00:00Z"))
        self.assertEqual(values[0].PowerKW, 1.5)
        self.assertEqual(values[1].Time, pd.Timestamp("2021-01-01T00:15:00Z"))
        self.assertEqual(values[1].PowerKW, 3.0)
        self.assertEqual(values[2].Time, pd.Timestamp("2021-01-01T01:30:00Z"))
