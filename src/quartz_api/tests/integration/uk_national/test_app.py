...
async def test_national_forecast_horizon_minutes(
    ...
    response = await api_client.get("/v0/solar/GB/national/forecast?forecast_horizon_minutes=120")
    assert response.status_code == 200
    data = response.json()
    assert isinstance(data, list)
    assert len(data) == 16
...
async def test_national_pvlive_day_after(
    ...
    response = await api_client.get("/v0/solar/GB/national/pvlive?regime=day_after")
    assert response.status_code == 200
    data = response.json()
    assert isinstance(data, list)
...
async def test_gsp_forecast(
    ...
    response = await api_client.get("/v0/solar/GB/gsp/1/forecast")
    assert response.status_code == 200
    data = response.json()
    assert isinstance(data, list)
    assert len(data) == 10
...
async def test_gsp_pvlive(
    ...
    response = await api_client.get("/v0/solar/GB/gsp/1/pvlive")
    assert response.status_code == 200
    data = response.json()
    assert isinstance(data, list)
    assert len(data) == 10
...
async def test_gsp_pvlive_all(
    ...
    response = await api_client.get("/v0/solar/GB/gsp/pvlive/all")
    assert response.status_code == 200
    data = response.json()
    assert isinstance(data, list)
    assert len(data) == 1
    ...
    response = await api_client.get("/v0/solar/GB/gsp/pvlive/all?gsp_ids=1,2,3")
    assert response.status_code == 200
    data = response.json()
    assert isinstance(data, list)
    assert len(data) == 10
...
async def test_gsp_status_check_last_forecast_run(
    ...
    response = await api_client.get("/v0/solar/GB/status/check_last_forecast_run")
    assert response.status_code == 200
    data = response.json()
